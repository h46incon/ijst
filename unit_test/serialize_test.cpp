...
IJST_DEFINE_STRUCT(
		NestSt
		, (IJST_TVEC(T_int), vec_1, "vec_val_1")
		, (IJST_TST(Inner), inner_1, "inner_val_1")
		, (IJST_TMAP(T_string), map_1, "map_val_1")
		, (IJST_TVEC(IJST_TST(Inner)), vec_2, "vec_val_2")
)
...
IJST_DEFINE_STRUCT(
		ObjRefSt
		, (IJST_TST(Inner), inner, "inner_val")
		, (IJST_TVEC(IJST_TST(Inner)), inner_v, "inner_v_val")
		, (IJST_TMAP(IJST_TST(Inner)), inner_m, "inner_m_val")
		, (IJST_TMAP(IJST_TVEC(IJST_TST(Inner))), inner_mv, "inner_mv_val")
)
...
IJST_DEFINE_STRUCT(
		Complicate1
		, (IJST_TST(Inner), i1, "i1_v")
		, (IJST_TST(Inner), i2, "i2_v")
		, (IJST_TST(Inner), i3, "i3_v")
		, (IJST_TST(Inner), i4, "i4_v")
)

IJST_DEFINE_STRUCT(
		Complicate2
		, (IJST_TST(Complicate1), c1, "c1_v")
		, (IJST_TVEC(IJST_TMAP(T_string)), vms, "vms_v")
		, (IJST_TMAP(IJST_TVEC(T_string)), mvs, "mvs_v")
		, (IJST_TMAP(IJST_TMAP(IJST_TST(Inner))), mmo, "mmo_v")
)
...
IJST_DEFINE_STRUCT(
	Container
	, (IJST_TVEC(T_int), dVector, "vec")
	, (IJST_TDEQUE(T_int), dDeque, "deque")
	, (IJST_TLIST(T_int), dList, "list")
)
